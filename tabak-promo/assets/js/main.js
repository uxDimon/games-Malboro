...
function showCustomPopup(message) {
  if (message.indexOf('молод') > -1) {
    $('.popup .text').text('Кажется, ты выглядишь слишком молодо. Возможно, ты не выполнил одно из условий. В любом случае стоит попробовать еще раз, чтобы изображение получилось более чётким, не засвеченным и не слишком затемненным.');
  } else {
